...
const Header: React.FC = () => {
  ...
  // Automatically close mobile menu on resize to large screen
  useEffect(() => {
    const handleResize = () => {
    ...
    >
      ...
      <NavbarContent className="hidden lg:flex space-x-8 list-none" justify="start">
        <NavbarItem className="whitespace-nowrap">
          <span
            className="material-symbols-rounded hover:text-gray-300 transform transition-all duration-200 hover:cursor-pointer"
            style={{ fontSize: "2rem" }}
          >
            home
          </span>
        ...
        <NavbarItem className="whitespace-nowrap hover:text-gray-300 transform transition-all duration-200">
        ...
        <NavbarItem
          isActive
          className="whitespace-nowrap hover:text-gray-300 transform transition-all duration-200"
        >
